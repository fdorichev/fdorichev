...
* **Курс «Разработка на Python» (УЦ МГТУ им. Н.Э. Баумана / Код Будущего):** Пройден. Программа объемом 144 академических часа. Изучил основы программирования, синтаксис языка и базовые алгоритмы для автоматизации.
  ...
  <img width="550" alt="sertifickat" src="https://github.com/user-attachments/assets/cb892462-2944-4830-baa9-ea4f7442841d" />
...
* **Читаю книги: "Внутреннее устройство Linux" - (Brian Ward) и "Командная строка Linux" - (Daniel J. Barrett).
