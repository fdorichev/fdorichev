...
* **Лекторий по SRE (Т-Образование):** [В процессе] Изучаю базоческие концепции отказоустойчивости систем, методологии мониторинга (SLI/SLO/SLA) и разборы инфраструктурных сбоев.
